<template>
 <div>
   ...
   <div class="list1">
   <img src="../../components/publics/d7f25cc4778c818926719e635e00ee44.jpg" alt="" class="title2">
   </div>
   ...
   <div class="products1 d-f a-i-c j-c-s-b">
      ...
      draggable scrollable
        ...
        @on-cancel="cancel">
       <div>
       <Input v-model="username" placeholder="收货人姓名" clearable style="width: 400px;" size="large"/>
       </div>
        <div class="m-t-20">
       <Input v-model="phone" placeholder="收货人电话" clearable style="width: 400px" size="large"/>
       </div>
        <div class="m-t-20">
       <Input v-model="address" placeholder="收货人地址" clearable style="width: 400px" size="large" />
       </div>
        <Checkbox v-model="single" class=" m-t-20">设为默认</Checkbox>
        <div v-if="this.username===null || this.phone===null || this.address===null" class="m-t-20">
         <Button type="success" disabled class="button">保存</Button>
        </div>
    ...
    <div class="list-title1">
      <div class="list-title2 d-f f-d-c j-c-c a-i-c">
       <div >
   ...
   mounted() {
      this.username=localStorage.getItem("username");
       ...
       this.$api.addAddress(
         ...
         ,phone:this.phone,address:this.address,isDefault}
       ).then(res=>{
         console.log(res);
       }).catch(err=>{
         console.log(err);
