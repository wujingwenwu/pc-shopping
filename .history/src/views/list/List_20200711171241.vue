      ...
      <div>
        ...
        <div class="list-title1">
          ...
          <div v-else class="list-title2">
            ...
            <div class="d-f">
             <div class="m-t-20 m-l-20">{{item.username}}</div>
             <div class="lists1 m-t-20">{{item.phone}}</div>
             <div class="lists1 m-t-20">{{item.address}}</div>
             <div v-if="item.isDefault===true" class="m-t-20">(默认地址)</div>
             <div v-else class="lists4"></div>
             <div class="lists2 m-l-20 m-t-20 d-f j-c-c a-i-c"><Icon type="ios-create-outline" class="outline"/></div>
             <div class="lists3 m-t-20 m-l-20 d-f j-c-c a-i-c" @click="shanchu(index)"><i class="iconfont icon-shanchu"></i></div>
             </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    shanchu(index){
      ...
      this.$api.deleteAddress(this.arr[index]._id).then(res=>{
