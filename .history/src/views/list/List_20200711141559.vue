 ...
 <div>
   ...
   <div class="products1 d-f a-i-c j-c-s-b">
      ...
      draggable scrollable
        ...
        @on-cancel="cancel">
       <div>
       <Input  placeholder="收货人姓名" clearable style="width: 400px;" size="large"/>
       </div>
        <div class="m-t-20">
       <Input  placeholder="收货人电话" clearable style="width: 400px" size="large"/>
       </div>
        <div class="m-t-20">
       <Input  placeholder="收货人地址" clearable style="width: 400px" size="large" />
       </div>
        <Checkbox v-model="single">设为默认</Checkbox>
    </Modal>
    </div>
