  ...
  <div>
    <div class="d-f">
      <div class="list d-f f-d-c a-i-c">
        ...
        <div class="m-t-20">{{usernames}}</div>
          ...
          >
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
              <FormItem label="username" prop="name">
                <Input v-model="formValidate.username" placeholder="收货人姓名"/>
              </FormItem>
              <FormItem label="phone" prop="number">
                <Input v-model="formValidate.phone" placeholder="收货人电话"/>
              </FormItem>
              <FormItem label="address" prop="name">
                <Input v-model="formValidate.address" placeholder="收货人地址4"/>
              </FormItem>
            </Form>
