<template>
  <div>
    <div class="d-f whole2">
      <div class="whole"  :class="{'tss':isActive1}"  @click="isActive1=true">综合排序</div>
      <div class="whole" @click="hingh" :class="{'tss':isActive2}">价格从低到高</div>
      <div class="whole"  @click="low" :class="{'tss':isActive3}">价格从高到低</div>
