    ...
    <div class="shopping3">
      <div v-for="(item,index) in arr" :key="index">
        <div class="d-f shopping5 m-l-20">
          <Checkbox class="m-t-30" @on-change="checkAllGroupChange(item)" v-model="check"></Checkbox>
      ...
      <div class="d-f j-c-s-b font2 a-i-c">
        <div class="d-f m-t-20 m-l-20">
          <Checkbox v-model="checkAll" @click="handleCheckAll" >全选</Checkbox>
