 ...
 <div class="shoppinfg">
  <div class="products1 d-f a-i-c">
   ...
   <div class="shopping3">
    ...
    <Checkbox class="m-t-30"></Checkbox>
    ...
    <div class="d-f shopping6">
     ...
     <div class="shopping1">{{item.count}}</div>
    <div class="shopping1">￥{{item.salePrice}}</div>
    <Icon type="md-close-circle" class=" circle" />
    </div>
      </div>
   </div>
   <div class="shopping7"></div>
   <div class="d-f j-c-s-b font2">
   <div class="d-f">
    <Checkbox class="">全选</Checkbox>
    <div class=" f-c-hu f-s-12">删除选中的商品</div>
    </div>
    <div class="d-f">
     <div>
     <div class=" f-s-16">已选中<span class=" f-c-ho m-l-10 f-s-16">0</span><span class="m-l-10 f-s-16">件商品</span></div>
     <div class="font f-s-16">共计<span class=" m-l-20 font f-s-16">3</span><span class=" font fonts f-s-16">件商品</span></div>
     </div>
     <div class="shopping8"></div>
     <div class="m-l-20">
     <div class="f-s-16">应付总额:<span class="f-c-ho f-w f-s-16">￥0</span></div>
     <div class="font1">应付总额不含运费</div>
     </div>
     <Button :size="buttonSize" type="primary" class="buttom">现在结算</Button>
    </div>
   </div>
   </div>
 </div>
